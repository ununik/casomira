...
foreach ($kategorieClass->getAllKategorie() as $kategorie) {
	print '<tr>';
	print '<td><div class="settings settingsRow" onclick="changeCategoryShort(\''.$kategorie['short'].'\', \''.$kategorie['id'].'\')"></td><td>'.$kategorie['short'].'</td>';
	print '<td><div class="settings settingsRow" onclick="changeCategoryLong(\''.$kategorie['long'].'\', \''.$kategorie['id'].'\')"></td><td>'.$kategorie['long'].'</td>';
